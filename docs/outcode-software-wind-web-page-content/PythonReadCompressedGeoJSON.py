####################################################################################
# Name:		PythonReadCompressedGeoJSON.py
# Date:		07-APR-2021
...
try:
    ...
    points_compressesed_geojson_filename    = os.path.join(python_scriptpath,'points-2020-al28-17-202010282100.json')

    geojson_compressed_file                 = gzip.open(points_compressesed_geojson_filename,'rb')
    ...
    print('PythonReadCompressedGeoJSON.py: processing complete.')
