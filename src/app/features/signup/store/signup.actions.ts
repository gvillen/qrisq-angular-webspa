...
export const actionFetchSubscriptionPlanListRequest = createAction(
  '[SignUp] Fetch Subscription Plan List Request'
);

export const actionFetchSubscriptionPlanListRequestSuccess = createAction(
  '[SignUp] Fetch Subscription Plan List Request Success',
  props<{ subscriptionPlans: Array<SubscriptionPlan> }>()
);

export const actionFetchSubscriptionPlanListRequestFailed = createAction(
  '[SignUp] Fetch Subscription Plan List Request Failed'
);
